const game = () => {
  ...
  const playMatch = () => {
    ...
    const computerOptions = ["kamen", "papir", "škare"];
    ...
    options.forEach(option => {
      option.addEventListener("click", function() {
        ...
        setTimeout(() => {
          ...
          playerHand.src = `./slike/${this.textContent}.png`;
          computerHand.src = `./slike/${computerChoice}.png`;
        }, 2000);
